...
def patch_file(fpath, dataset_flag, target_col, exp_id):
    """Load JSON, recompute cv_class_weights from training distribution, save patched file"""
    ...
    for model_name, metrics in results.items():
        ...
        for fs in filter_sizes:
            ...
            new_cv_values.append(compute_cvcf(class_counts))

        # Overwrite cv_class_weights with corrected values
        metrics["cv_class_weights"] = new_cv_values
